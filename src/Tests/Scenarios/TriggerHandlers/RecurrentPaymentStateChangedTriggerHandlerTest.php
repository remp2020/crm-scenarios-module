...
class RecurrentPaymentStateChangedTriggerHandlerTest extends BaseTestCase
{
    ...
    {
        /** @var RecurrentPaymentStateChangedTriggerHandler $recurrentPaymentStateChangedTriggerHandler */
        $recurrentPaymentStateChangedTriggerHandler = $this->inject(RecurrentPaymentStateChangedTriggerHandler::class);
        $this->assertSame('recurrent_payment_state_changed', $recurrentPaymentStateChangedTriggerHandler
            ->getKey());
    }
    ...
    public function testEventType(): void
    {
        /** @var RecurrentPaymentStateChangedTriggerHandler $recurrentPaymentStateChangedTriggerHandler */
        $recurrentPaymentStateChangedTriggerHandler = $this->inject(RecurrentPaymentStateChangedTriggerHandler::class);
        $this->assertSame('recurrent-payment-state-changed', $recurrentPaymentStateChangedTriggerHandler
            ->getEventType());
    }
    ...
    public function testHandleEvent(): void
    {
        ...
        /** @var RecurrentPaymentStateChangedTriggerHandler $recurrentPaymentStateChangedTriggerHandler */
        $recurrentPaymentStateChangedTriggerHandler = $this->inject(RecurrentPaymentStateChangedTriggerHandler::class);
        $triggerData = $recurrentPaymentStateChangedTriggerHandler->handleEvent([
            'recurrent_payment_id' => $recurrentPayment->id,
        ]);

        $this->assertSame($user->id, $triggerData->userId);
        $this->assertSame(array_keys($triggerData->payload), $recurrentPaymentStateChangedTriggerHandler->getOutputParams());
        $this->assertSame([
            'user_id' => $user->id,
            'recurrent_payment_id' => $recurrentPayment->id,
    ...
    public function testHandleEventMissingRecurrentPaymentId(): void
    {
        ...
        /** @var RecurrentPaymentStateChangedTriggerHandler $recurrentPaymentStateChangedTriggerHandler */
        $recurrentPaymentStateChangedTriggerHandler = $this->inject(RecurrentPaymentStateChangedTriggerHandler::class);
        $recurrentPaymentStateChangedTriggerHandler
            ->handleEvent([]);
    }
